...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(i-ching)
...
before packages are loaded."
  ...
  (set-fontset-font t 'unicode (font-spec :family "DejaVu Sans" :size 16) nil 'append)
)
