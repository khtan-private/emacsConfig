...
*** jasmine
**** This is MQ's laptop repurposed for PP and home and travel
HOME is currently d:\users\tikus\kingston\mingqian
c:\users\poi is clean and empty

1. emacs is 26.3 while air has 28.2, but don't upgrade until necessary
2. 26.3 is too old for spacemacs
   Might as well leapfrog to the latest emacs
