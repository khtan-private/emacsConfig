...
2. Also although firstAm does not allow outside PCs to remote desktop into it, it can remote into outside PCs.
   Thus we can rdp to //air with WORKGROUP\khtan as the user
...
| bin         | https://github.com/khtan-private/khtan-bin.git   |
| emacsConfig | https://github.com/khtan-private/emacsConfig.git |
| .emacs.d    | https://github.com/plexus/chemacs2.git           |
wt
HOME needs to be set
cp emacsConfig/chemacs2Config/emacs-profiles.el .emacs-profiles.el
